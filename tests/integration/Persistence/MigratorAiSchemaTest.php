...
/**
 * Schema-level evidence for steps 19–21 (M09, docs/adr/0028): clean
 * install reaches db_version 21 with the AI config singleton row seeded,
 * the AI drafts table present with its lease/claim columns, and the
 * conversations table's new nullable acknowledgement column. The claim
 * compare-and-set and acknowledgement-gate semantics themselves are
 * proven at the repository layer instead — this file only exercises the
 * migration steps, via INFORMATION_SCHEMA and the seeded row.
 */
final class MigratorAiSchemaTest extends WP_UnitTestCase {

	public function test_clean_install_reaches_db_version_21_with_ai_tables_and_seeded_config_row(): void {
		global $wpdb;
