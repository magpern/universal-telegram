...
final class MigrationLifecycleTest extends WP_UnitTestCase {
	...
	public function test_target_version_is_40_and_monotonic(): void {
		...
		self::assertSame( 40, $probe->target() );
	}
	...
	public function test_fresh_install_creates_only_retained_schema_and_never_a_legacy_table(): void {
		...
		self::assertSame( '40', (string) get_option( 'universal_telegram_db_version' ) );
