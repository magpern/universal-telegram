...
- `docs/plans/sc-m03-final-cutover-f1-channel-case-ref-remediation-plan-v1.md` (Proposed; documentation-only; primary plan for finding F1 — introduces ADR-0043 pinning Support Chat ADR-0011; corrects the adapter to send `ChannelBinding::support_conversation_uuid()` as the Contract v1 `channel_case_ref`; no schema change; implementation gated on Product Owner acceptance of both ADRs; DEV rehearsal runbook v2 and Tier 1 re-attempt are separate later steps)
