...
- `docs/plans/ut-adapter-m1-universal-support-chat-adapter-plan-v1.md` (ADR-0037; pins Support Chat Contract v1 SHA `dff2730e24b7d3f70f15f706305e12e14fdcc6c8`)
