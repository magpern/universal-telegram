...
- Commit SHA: `<SC_ADR0010_MERGE_SHA>` (placeholder, replaced with the real merge SHA once Support Chat PR #16 merges, before this ADR's own PR merges)
- Canonical URL: `https://github.com/magpern/universal-support-chat/blob/<SC_ADR0010_MERGE_SHA>/docs/adr/0010-final-cutover-handoff-contract-and-cohort-activation.md`
...
**No final-cutover implementation code may begin until ADR-0042 is merged. Support Chat's SC-M03 final-cutover implementation may not begin until both ADR-0042 and Support Chat's own ADR-0010 are merged to their respective `main` branches.**
