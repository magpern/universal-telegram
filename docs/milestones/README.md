...
| UT Adapter M1 | Universal Support Chat Adapter | [ut-adapter-m1-universal-support-chat-adapter.md](ut-adapter-m1-universal-support-chat-adapter.md) | Implemented and merged (PR #32); **signed-client follow-up pinned, not yet implemented (ADR-0038)** | ADR-0037; Contract v1 pin; ADR-0038; Support Chat ADR-0007 pin; SC-M01/SC-M02; closure `docs/closure/ut-adapter-m1-universal-support-chat-adapter-closure.md` |
