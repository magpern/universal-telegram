...
| 10 | ChatWidget | `UniversalTelegram\ChatWidget` | Core slice implemented at M06 (ADR-0021 amendment, ADR-0022): availability gating, cache-safe asset enqueue, and the visitor-facing widget consuming M05's REST contract only; chat profiles/targeting, business hours, pre-chat form, visual/CSS controls, and page-builder embeds remain deferred, unscheduled charter items |
