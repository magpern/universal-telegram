 ...
 */
class OperatorIdentityMapRepository {
	 ...
	 *
	 * @return OperatorIdentityMap|null
	 */
	public function create( int $wp_user_id, int $telegram_user_id, ?string $telegram_username, int $created_by ): ?OperatorIdentityMap {
	 ...
	 * @return OperatorIdentityMap|null
	 */
	public function find( int $id ): ?OperatorIdentityMap {
		if ( ! $this->schema_health->is_available() ) {
			return null;
		}
	 ...
	 * @return OperatorIdentityMap|null
	 */
	public function find_by_wp_user_id( int $wp_user_id ): ?OperatorIdentityMap {
		if ( ! $this->schema_health->is_available() ) {
			return null;
		}
	 ...
	 * @return OperatorIdentityMap|null
	 */
	public function find_by_telegram_user_id( int $telegram_user_id ): ?OperatorIdentityMap {
		if ( ! $this->schema_health->is_available() ) {
			return null;
		}
	 ...
	 *
	 * @return array<int, OperatorIdentityMap>
	 */
	...
	/**
	 * Hydrates one database row into an OperatorIdentityMap.
	 *
	 * @param array<string, mixed> $row The raw database row.
	 *
	 * @return OperatorIdentityMap
	 */
	private function hydrate( array $row ): OperatorIdentityMap {
		return new OperatorIdentityMap(
			(int) $row['id'],
			(int) $row['wp_user_id'],
