...
final class EventCatalogLabels {
	...
	private const EVENT_TYPE_LABELS = array(
		...
		'fluent_contact_inbox.contact_request_submitted' => 'Contact form request submitted',
		'fluent_contact_inbox.ticket_created'            => 'New support ticket created (from email)',
		'fluent_contact_inbox.ticket_reply_received'     => 'Customer replied to a support ticket',
	...
	private const FIELD_LABELS = array(
		...
		'subject.ticket_id'          => 'Support ticket ID',
		'payload.ticket_number'      => 'Support ticket number',
		'payload.subject'            => 'Subject',
		'payload.message_text'       => 'Message text',
		'payload.customer_name'      => 'Customer name',
		'payload.customer_email'     => 'Customer email address',
		'payload.source'             => 'Where the request came from',
	);
